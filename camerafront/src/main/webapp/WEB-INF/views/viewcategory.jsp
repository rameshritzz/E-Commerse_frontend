		...
		<div class="col-lg-12">
			...
			<ul class="event-list">
				<c:forEach items="${categorylist}" var="f">
					<li>
						<div class="info">
							<h2 class="title">${f.catename}</h2>
							<p class="desc">${f.catedescription}</p>
							<ul>
								<li style="width: 50%;"><a href="${cr}/admin/editcategory?catid=${f.cateid}"><span
										class="fa fa-edit"></span> Edit</a></li>
								<li style="width: 50%;"><a
									href="${cr}/admin/deletecategory?catid=${f.cateid}"><span
