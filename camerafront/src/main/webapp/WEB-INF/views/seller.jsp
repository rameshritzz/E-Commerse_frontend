...
<div class="container">
	...
	<c:if test="${!editmode}">
		<c:set var="url" value="${cr}/admin/addseller" />
	</c:if>

	<c:if test="${editmode}">
		<c:set var="url" value="${cr}/admin/updateseller" />
	...
	<form:form class="form-horizontal" modelAttribute="sellermodel"
		...
		<c:if test="${editmode}">
			<div class="form-group">
				<label for="username" class="text-info">Seller ID:</label><br>
				<form:input type="text" name="username" id="username"
					class="form-control" path="sellerid" readonly="true" />
			</div>
		</c:if>
		<div class="row">
			...
			<div class="col-md-6">
				<div class="form-group">
					<div class="input-group mb-2 mr-sm-2 mb-sm-0">
						...
						<form:input type="text" name="username" id="username"
							class="form-control" path="sellername" />
				...
				<div class="form-group has-danger">
					<div class="input-group mb-2 mr-sm-2 mb-sm-0">
						...
						<form:textarea type="text" name="description" class="form-control"
							id="description" path="sellerlocation"></form:textarea>
						<form:errors path="sellerlocation"></form:errors>
					</div>
				</div>
			</div>
		</div>
